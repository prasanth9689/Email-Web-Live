...
$Sql_Query = "SELECT post_table.id , 
   ...
   user_comments comments_table
    ...
    LEFT JOIN 
     ...
     LEFT JOIN 
      user_likes likes_table_status ON  likes_table_status.user_id = '1' AND likes_table_status.status = '1' AND likes_table_status.post_id =  post_table.id WHERE post_table.user_id = '$user_id' AND post_table.media_type = '$media_type'
