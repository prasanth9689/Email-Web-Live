...
<title>User Login</title>
    <link rel="canonical" href="https://codepen.io/Kamilica/pen/XRbvaL">
...
<nav class="navbar p-0 fixed-top">
      <!-- <button style="margin-top: 15px;" class="navbar-toggler navbar-toggler-left rounded-0 border-0" type="button" data-toggle="collapse" data-target="#megamenu-dropdown" aria-controls="megamenu-dropdown" aria-expanded="false" aria-label="Toggle navigation">
        <i class="fa fa-bars"></i><span class="ml-3">Advanced</span>
      </button> -->
  
  <div>
    <a class="navbar-brand px-1" href="#">
        <img src="https://skyblue.co.in/login/dashboard/skyblue.png" class="d-inline-block mt-1" alt="AgentFire Logo" height="70">
...
<div data-component="sidebar">
  ...
  <ul class="list-group flex-column d-inline-block first-menu">
    <li class="list-group-item pl-3 py-2">
      <a href="#"><i class="fa fa-home" aria-hidden="true"><span class="ml-2 align-middle">Dashboard</span></i></a>
    ...
    <li class="list-group-item pl-3 py-2">
      <a href="#"><i class="fa fa-user-o" aria-hidden="true"><span class="ml-2 align-middle">Products</span></i></a>
      <ul class="list-group flex-column d-inline-block submenu">
        <li class="list-group-item pl-4">
    ...
    <li class="list-group-item pl-3 py-2">
      <a href="#">
        <i class="fa fa-user-o" aria-hidden="true"><span class="ml-2 align-middle">Inbox</span></i>
      </a>
      <ul class="list-group flex-column d-inline-block submenu">
    ...
    <li class="list-group-item pl-3 py-2">
      <a href="#"><i class="fa fa-user-o" aria-hidden="true"><span class="ml-2 align-middle">Notification</span></i></a>
    ...
    <li class="list-group-item pl-3 py-2">
      <a href="#"><i class="fa fa-gear" aria-hidden="true"><span class="ml-2 align-middle">Settings</span></i></a>
      <ul class="list-group flex-column d-inline-block submenu">
        <li class="list-group-item pl-4">
    ...
    <li class="list-group-item pl-3 py-2">
      <a href="#"><i class="fa fa-credit-card" aria-hidden="true"><span class="ml-2 align-middle">Billing</span></i></a>
      </li>
    
    <li class="list-group-item pl-3 py-2">
      <a href="#"><i class="fa fa-support" aria-hidden="true"><span class="ml-2 align-middle">Support</span></i></a>
      <!-- <ul class="list-group flex-column d-inline-block submenu">
        <li class="list-group-item pl-4">
    ...
    <li class="list-group-item pl-3 py-2">
      <a href="logout.php"><i class="fa fa-sign-out " aria-hidden="true"><span class="ml-2 align-middle">Logout</span></i></a>
      </li>
